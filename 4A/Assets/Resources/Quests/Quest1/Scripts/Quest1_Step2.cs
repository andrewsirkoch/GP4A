...
public class Quest1_Step2 : MonoBehaviour
{
    ...
    {
        if (PlayerPrefs.GetInt("quest_1_step_1_completed") == 1 && Input.GetKeyUp(KeyCode.W) && collision.gameObject.name == "Player")
        {
            numOfKnocks += 1;
                ...
                if (child.name == "ChatBubble")
                {
                    ...
                    foreach (Transform childOfChild in child)
                    {
                        if (childOfChild.name == "chat")
                        {
                            ...
                            if (childOfChild.localPosition.y >= 6)
                            {
                                chatRunning = false;
                                child.gameObject.SetActive(false);
                                chatRan = true;
